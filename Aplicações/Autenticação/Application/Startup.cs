...
using Module = Middleware.Domain.Models.Module;
...
namespace middleware_autorization_authentication_auditing
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(option => option.AddPolicy("Manager", policy => policy.RequireAssertion( p=> p.User.IsInRole("Manager") || p.User.IsInRole("Admin"))));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            loggerFactory.AddFile("Logs/SystemOut-{Date}.log");
