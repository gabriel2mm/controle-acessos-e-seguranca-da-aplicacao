...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20200908191638_TesteMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Middleware.Domain.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Middleware.Domain.Models.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DescriptionDeclineApproval")
                        .HasColumnName("DescriptionDeclineApproval")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Middleware.Domain.Models.Order", b =>
                {
                    b.HasOne("Middleware.Domain.Models.Request", "Request")
                        .WithMany()
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Middleware.Domain.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
