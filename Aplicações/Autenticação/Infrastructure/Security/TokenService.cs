...
namespace Middleware.Infrastructure.Security
{
    ...
    public static class TokenService
    {
        ...
        public static String GenerateToken(User user, byte[] key, Dictionary<Role, IList<Claim>> pairRoles)
        {
        ...
        public static Claim[] Claims(User user, Dictionary<Role, IList<Claim>> pairRoles)
        {
            ...
            foreach (KeyValuePair<Role, IList<Claim>> entry in pairRoles)
            {
